export const CARDS = [
  ...
  {
    card: '1_a_maga',
    title: 'A Maga, a criadora',
    tagline: 'A Rosa vermelha simboliza amor e poder criativo',
  ...
  },
  {
    ...
    title: 'A Sacerdotisa, a intuitiva',
    tagline: 'A rosa azul representa o mistério e os segredos ocultos.',
    suggested_music:
      'https://open.spotify.com/embed/track/1mea3bSkSGXuIRvnydlB5b?utm_source=generator',
  ...
  {
    card: '3_a_imperatriz',
    title: 'A Imperatriz - A nutridora.',
    tagline: 'A Rosa amarela simboliza amizade e luz, representando a fertilidade e cuidado.',
    suggested_music:
  ...
  {
    card: '5_o_sacerdote',
    title: 'O Sacerdote, o papa',
    tagline: 'Representa espiritualidade e a busca pelo conhecimento mais profundo.',
    suggested_music:
  ...
  },
  {
    card: '6_os_amantes',
    title: 'Os Amantes',
    tagline: 'Rosas entrelaçadas, simbolizando amor e união.',
    suggested_music:
  ...
  {
    card: '8_a_justica',
    title: 'A Justiça, a equilibradora',
    tagline: 'A Rosa dourada representando justiça e valor de decisões justas.',
    suggested_music:
  ...
  {
    card: '9_o_eremita',
    title: 'O Eremita, a Sábia',
    tagline: 'A Rosa de inverno, simbolizando introspecção, reflexão e sabedoria interior.',
    suggested_music:
  ...
  {
    card: '11_a_forca',
    title: 'A Força, é a corajosa',
    tagline: 'Rosa com espinhos simbolizando a força e a superação.',
    suggested_music:
  ...
  {
    card: '12_o_enforcado',
    title: 'O Enforcado, a transformadora',
    tagline:
      'É a rosa suspensa, simbolizando sacrificio e mudança de perspectiva, é um novo ponto de vista diferemte sobre a situação',
    suggested_music:
  ...
  {
    card: '15_o_diabo',
    title: 'O Diabo, é a libertina',
    tagline: 'Rosa espinhosa, simbolizando os desafios e as tentações',
    suggested_music:
  ...
  {
    card: '16_a_torre',
    title: 'A Torre, a reveladora',
    tagline: 'Rosa em chamas, representando a quebra de ilusões.',
    suggested_music:
  ...
  {
    card: '17_a_estrela',
    title: 'A Estrela, a sonhadora',
    tagline: 'Rosa brilhante, simbolizando esperança e inspiração.',
    suggested_music:
  ...
  {
    card: '18_a_lua',
    title: 'A Lua, a mística',
    tagline: 'Rosa prateada, simbolizando intuição e mistério.',
    suggested_music:
      'https://open.spotify.com/embed/track/1mea3bSkSGXuIRvnydlB5b?utm_source=generator',
  ...
  {
    card: '19_o_sol',
    title: 'O Sol, a radiante',
    tagline: 'Rosa dourada radiante, simbolizando alegria e sucesso.',
    suggested_music:
  ...
  },
  {
    ...
    title: 'O Julgamento, a reavivadora',
    tagline: 'Rosa renascente, simbolizando renovação e transformação.',
    suggested_music:
  ...
  {
    card: '21_o_mundo',
    title: 'O Mundo, a completa',
    tagline: 'Rosa em um circulo, representando a realização e a completude.',
    suggested_music:
...
// Função para pegar uma carta do dia
export function getCardOfTheDay() {
  const randomIndex = Math.floor(Math.random() * CARDS.length);
  return CARDS[randomIndex];
}

// Função para pegar três cartas
export function getThreeCards() {
  const shuffledCards = CARDS.sort(() => 0.5 - Math.random());
  return shuffledCards.slice(0, 3);
}

// Função para pegar cinco cartas
export function getFiveCards() {
  const shuffledCards = CARDS.sort(() => 0.5 - Math.random());
